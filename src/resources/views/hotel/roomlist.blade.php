        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-area">
                    ...
                    <a href="rooms-list" class="btn btn-fill btn-default">Rooms Listing</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-md-8 col-xs-12">
                ...
                <div class="block-heading">
                    ...
                    <div class="toggle-view pull-right">
                        <a href="rooms-list-html" class="active-view-btn">
                            <i class="fa fa-th-list"></i>
                        </a>
                        <a href="rooms-grid" class="change-view-btn">
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-1.jpg" alt="bedroom-1" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-2.jpg" alt="list-room-4" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-3.jpg" alt="list-room-6" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-9.jpg" alt="list-room-9" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-5.jpg" alt="list-room-9" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-6.jpg" alt="list-room-10" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-7.jpg" alt="list-room-11" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-8.jpg" alt="list-room-12" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
                ...
                <div class="rooms-list-box clearfix">
                    <div class=" row-table row-flush">
                        <div class="col-lg-4  col-md-4 col-sm-4 col-xs-12 rooms-pic">
                            <img src="/images/list-room-4.jpg" alt="list-room-4" class="img-responsive">
                        </div>
                        <!-- Detail Body -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 detail-body">
                            <!-- Header -->
