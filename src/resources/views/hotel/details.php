                        ...
                        <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                            <div class="carousel-outer">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <?php $images = App\Hotel_image::where('hotel_id', '=', $hotel->hotel_id)->get(); ?>
                            ...
                            <ol class="carousel-indicators thumbs visible-lg visible-md">
                                @forelse($images as $image)
                                <li data-target="#carousel-custom" data-slide-to="0" class="active"><img src="../../../../uploads/hotel/{{$image->hotel_image}}" alt="{{$hotel->hotel_name}}"></li>
                                @empty
                                @endforelse
                            </ol>
                        </div>
